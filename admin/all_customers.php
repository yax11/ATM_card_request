                ...
                <table class="table align-items-center justify-content-center mb-0 display" id="all_customers"  style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Other Name</th>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Act. No.</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Balance</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
...
$q = "SELECT * FROM `customers` WHERE '1' ORDER BY `first_name` ASC LIMIT 20 ";
...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active " href="./all_customers.php">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="col mb-xl-0 mb-4">
                ...
                if ($query->num_rows > 0){
                    ...
                    while ($row = $query->fetch_assoc()){
                        ...
                        $pn = $row['phone_number'];
                        $email = $row['email'];
                        $act_no = ltrim($row['account_number'], "N");
                        $bvn = $row['BVN'];
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm">$fn</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">$ln</p>
                      </td>
                      <td>
                        <span class="text-xs font-weight-bold">$on</span>
                      </td>

                      <td>
                        <span class="text-xs font-weight-bold">$pn</span>
                      </td>
                      ...
                      <td>
                        <span class="text-xs font-weight-bold">$act_no</span>
                      </td>

                      <td>
                        <span class="text-xs font-weight-bold">$bal</span>
                      </td>
